...
- [PS-26024](./PS-26024.md) — AI-Based Smart Governance and Compliance Monitoring System for Coal Mines *(same organization, same theme, domain overlap)*
- [PS-26025](./PS-26025.md) — Development of an AI-enabled Low Cost Real Time Mine Subsidence Monitoring, *(same organization, same theme, tech overlap (2))*
...
- [PS-26011](./PS-26011.md) — 3D ULPIN Generation and vertical Property Mapping SYstem *(same theme, tech overlap (2))*
- [PS-26013](./PS-26013.md) — Automated lntegration and lntelligent Harmonization of Multi-source Geospat *(same theme, tech overlap (2))*
