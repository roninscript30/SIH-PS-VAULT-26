...
aliases:
  - "PS 26229"
  - "SIH 26229"
  - "Kabadiwala Connect – Bringing the Informal"
tags:
  - sih2026
  - software
  - clean-green-technology
---
# PS 26229 — Kabadiwala Connect – Bringing the Informal Collector into the Formal Recycling Chain

> [!info] Quick Reference
> **Organization**: [Ministry of Mines (MoM)](../03-Organizations/Ministry-of-Mines-MoM.md)
> **Department**: Jawaharlal Nehru Aluminium Research Development and Design Centre (JNARDDC)
...
**Technologies**: [AI-and-ML](../04-Technologies/AI-and-ML.md) · [GPS-and-Navigation](../04-Technologies/GPS-and-Navigation.md) · [Mobile-Development](../04-Technologies/Mobile-Development.md)

**Domains**: [E-Governance](../05-Domains/E-Governance.md) · [Education-and-Skilling](../05-Domains/Education-and-Skilling.md) · [Healthcare](../05-Domains/Healthcare.md)
...
- [PS-26028](./PS-26028.md) — Dynamic Forecast of Expected Time of Arrival (ETA) for Coaching Trains *(tech overlap (3))*
...
- [PS-26109](./PS-26109.md) — Al-Based Predictive Modelling for Early Forecasting of Bovine Mastitis in l *(tech overlap (3))*
- [PS-26155](./PS-26155.md) — AI-Driven Multi-Vendor Network Security Compliance Auditor *(tech overlap (2), domain overlap)*
- [PS-26168](./PS-26168.md) — AI-ML based Intelligent Dead Reckoning system for seamless navigation *(tech overlap (3))*
