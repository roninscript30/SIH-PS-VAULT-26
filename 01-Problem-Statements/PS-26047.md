...
---
# PS 26047 — Patient Case-Taking Software
...
> **Dataset Reference Note**: Additional Information regarding PS https://drive.google.com/file/d/1mQ6Qp2MKL8JXdL2kJYqV-SFqcfbxSvrd/view?usp=drive_link
...
**Domains**: [Disaster-Response](../05-Domains/Disaster-Response.md) · [E-Governance](../05-Domains/E-Governance.md) · [Education-and-Skilling](../05-Domains/Education-and-Skilling.md) · [Healthcare](../05-Domains/Healthcare.md)
...
- Generic document scanners digitize images but do not extract, structure, or chronologically organize clinical content, nor link it to a structured history or ABHA record. 2.3 Specific Challenges a Solution Must Overcome
...
- [PS-26045](./PS-26045.md) — IP-SAKTI Sahayak a multilingual, RAG-based (source-cited) AI assistant for  *(same organization, same theme, tech overlap (2), domain overlap)*
...
- [PS-26003](./PS-26003.md) — AI-Based Cognitive Gaming and Memory Assistance Platform for Elderly Dement *(same theme, tech overlap (2), domain overlap)*
- [PS-26048](./PS-26048.md) — iKwath - a pod-based smart Kwatha (Kadha) maker that prepares a fresh, AFI/ *(same organization, same theme)*
- [PS-26093](./PS-26093.md) — AI-Based Real-Time Stress and Trauma Assessment Module for Victims/Complain *(same theme, tech overlap (2), domain overlap)*
