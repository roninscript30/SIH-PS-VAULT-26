...
aliases:
  - "PS 26056"
  - "SIH 26056"
  - "Development of a Real-time Airfare Price Index"
tags:
  - sih2026
  - software
  - smart-automation
---
# PS 26056 — Development of a Real-time Airfare Price Index for India through Automated Web Scraping of Airline and Online Travel Aggregator Portals for Augmentation of the Consumer Price Index (CPI).
...
> **Official Links**: [SIH Portal](https://www.sih.gov.in/sih2026PS) · [Dataset/Reference](https://esankhyiki.mospi.gov.in)


### 🔧 Key Classifications

**Technologies**: [Robotics](../04-Technologies/Robotics.md) · [Web-Platforms](../04-Technologies/Web-Platforms.md)
...
- [PS-26102](./PS-26102.md) — Development of an AI-powered system to detect anomalies, fraud, and ineffic *(same organization, same theme)*
- [PS-26103](./PS-26103.md) — Use case on web-based integrated project-monitoring platform *(same organization, same theme)*
...
- [PS-26101](./PS-26101.md) — Develop an AI enabled learning platform that identifies competency gaps, re *(same organization)*
- [PS-26123](./PS-26123.md) — Edge-AI Based Distributed Fleet Coordination for Autonomous Mobile Robots ( *(same theme, tech overlap (2))*
