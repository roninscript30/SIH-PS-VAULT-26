...
> **Dataset Reference Note**: -Check nciipc.gov.in; helpdesk1@nciipc.gov.in -Use publicly available datasets such as CIC-IDS2017/2018, UNSW-NB15, CTU-13, CICIoT2023, LANL Authentication Dataset, DARPA Intrusion Detection datasets, together with public knowledge bases such as MITRE ATT&CK, CAPEC, CVE/NVD and other open cybersecurity resources.
...
- [PS-26156](./PS-26156.md) — Universal Log Pre-processing Framework *(same organization, same theme, tech overlap (3))*
- [PS-26157](./PS-26157.md) — Supervisory Analytics Tool for SOC Assessment (SAT-SA) *(same organization, same theme, tech overlap (3))*
