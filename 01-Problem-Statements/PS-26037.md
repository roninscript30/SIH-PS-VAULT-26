...
> **Dataset Reference Note**: Teams may use built-in sensor and scenario datasets available in MathWorks Automated Driving Toolbox, RoadRunner sample scenes, synthetic scenarios created by the team, and publicly available traffic datasets relevant to Indian road conditions. -Indian Driving Dataset (IDD): https://idd.insaan.iiit.ac.in/ -Mendeley traffic dataset: https://data.mend
...
- [PS-26053](./PS-26053.md) — Adaptive Variable Resolution 2.5D Lidar Mapping for Dynamic Environment Per *(same theme, tech overlap (3))*
- [PS-26168](./PS-26168.md) — AI-ML based Intelligent Dead Reckoning system for seamless navigation *(same theme, tech overlap (2), domain overlap)*
