...
aliases:
  - "PS 26051"
  - "SIH 26051"
  - "Software Based Model Development for Design of"
tags:
  - sih2026
  - software
  - agriculture,-foodtech-rural-development
---
# PS 26051 — Software Based Model Development for Design of Area Specific Shelter for Thermal Comfort Maintenance.
...
**Technologies**: [Cloud-Computing](../04-Technologies/Cloud-Computing.md)
...
- [PS-26052](./PS-26052.md) — To develop an AI/ML-enabled adaptive noise cancellation (ANC) system that e *(same organization)*
- [PS-26053](./PS-26053.md) — Adaptive Variable Resolution 2.5D Lidar Mapping for Dynamic Environment Per *(same organization)*
- [PS-26054](./PS-26054.md) — AI-Enabled Real-Time Digital Twin System for Health Monitoring, Fault Predi *(same organization)*
