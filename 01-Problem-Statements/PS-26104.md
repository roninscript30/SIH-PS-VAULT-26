...
- [PS-26105](./PS-26105.md) — AI-Powered Continuous Cyber Risk Quantification and Investment Optimization *(same organization, same theme, tech overlap (3))*
- [PS-26106](./PS-26106.md) — AI-Powered Email Threat Detection, GeoLocation and Forensic Intelligence Pl *(same organization, same theme, tech overlap (3))*
- [PS-26026](./PS-26026.md) — Development of Mobile (Quadruped)/Handheld Device/System for Real-Time Dete *(same theme, tech overlap (2))*
- [PS-26052](./PS-26052.md) — To develop an AI/ML-enabled adaptive noise cancellation (ANC) system that e *(tech overlap (3))*
- [PS-26101](./PS-26101.md) — Develop an AI enabled learning platform that identifies competency gaps, re *(tech overlap (3))*
