...
- [PS-26077](./PS-26077.md) — AI-Driven Hyper-Local Early Warning System for Severe Weather Nowcasting *(same organization, tech overlap (3), domain overlap)*
- [PS-26084](./PS-26084.md) — Convective scale nowcasting for Thunderstorms, Hail & Cloudbursts (06 hr) *(same organization, tech overlap (3), domain overlap)*
- [PS-26025](./PS-26025.md) — Development of an AI-enabled Low Cost Real Time Mine Subsidence Monitoring, *(same theme, tech overlap (4), domain overlap)*
