...
- [PS-26171](./PS-26171.md) — On-device Visual Perception for Light-weight Browser Agents *(same organization, tech overlap (3))*
...
- [PS-26026](./PS-26026.md) — Development of Mobile (Quadruped)/Handheld Device/System for Real-Time Dete *(tech overlap (4), domain overlap)*
