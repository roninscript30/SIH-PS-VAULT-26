...
- [PS-26025](./PS-26025.md) — Development of an AI-enabled Low Cost Real Time Mine Subsidence Monitoring, *(same organization, same theme, tech overlap (4))*
- [PS-26023](./PS-26023.md) — AI-Powered Geological, Mining and other Reporting Solution for CMPDI/CIL su *(same organization, same theme, domain overlap)*
