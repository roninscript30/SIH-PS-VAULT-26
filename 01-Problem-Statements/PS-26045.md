...
- [PS-26047](./PS-26047.md) — Patient Case-Taking Software *(same organization, same theme, tech overlap (2), domain overlap)*
- [PS-26046](./PS-26046.md) — AIIA Clinical Trials Dashboard - a real-time, cloud-based, GCP-compliant Cl *(same organization, same theme, domain overlap)*
- [PS-26048](./PS-26048.md) — iKwath - a pod-based smart Kwatha (Kadha) maker that prepares a fresh, AFI/ *(same organization, same theme)*
- [PS-26094](./PS-26094.md) — AI-Powered Dynamic Mental Health Monitoring and Distress Prediction System  *(same theme, tech overlap (2), domain overlap)*
- [PS-26003](./PS-26003.md) — AI-Based Cognitive Gaming and Memory Assistance Platform for Elderly Dement *(same theme, tech overlap (2))*
