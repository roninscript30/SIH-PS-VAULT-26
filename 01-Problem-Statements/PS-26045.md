...
aliases:
  - "PS 26045"
  - "SIH 26045"
  - "IP-SAKTI Sahayak a multilingual, RAG-based"
tags:
  - sih2026
  - software
  - toys-games
---
# PS 26045 — IP-SAKTI Sahayak a multilingual, RAG-based (source-cited) AI assistant for Intellectual Property and regulatory guidance in Ayurveda, across national and international regimes.
...
> **Dataset Reference Note**: <b>The corpus can be assembled from open, authoritative public sources; representative examples:</b><br><br> &#8226; Traditional Knowledge Digital Library (TKDL) â€” tkdl.res.in<br> &#8226; Statutes &amp; rules â€” India Code, indiacode.nic.in<br> &#8226; IP India public databases (patents/InPASS, trade marks, designs, GI Registry) â€” ipindia.gov.in<br
...
**Domains**: [E-Governance](../05-Domains/E-Governance.md) · [Healthcare](../05-Domains/Healthcare.md)
...
- [PS-26047](./PS-26047.md) — Patient Case-Taking Software *(same organization, tech overlap (2), domain overlap)*
- [PS-26046](./PS-26046.md) — AIIA Clinical Trials Dashboard - a real-time, cloud-based, GCP-compliant Cl *(same organization, domain overlap)*
...
- [PS-26094](./PS-26094.md) — AI-Powered Dynamic Mental Health Monitoring and Distress Prediction System  *(tech overlap (2), domain overlap)*
