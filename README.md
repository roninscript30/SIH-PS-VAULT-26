...
[![Software](https://img.shields.io/badge/Software-176-green.svg)](06-Indexes/category_index.md)
[![Hardware](https://img.shields.io/badge/Hardware-55-red.svg)](06-Indexes/category_index.md)
...
|--------|------:|-------------|
| **Total Problem Statements** | **231** | Complete official release |
| **Unique Ministry/Org Problems** | **231** | Targeted problem statements |
| **Student Innovation Slots** | **0** | Open-ended AICTE innovation themes |
| **Software Problems** | **176** | Web, Mobile, AI/ML, Cloud, GIS, Data platforms |
| **Hardware Problems** | **55** | Embedded systems, Robotics, Drones, IoT, Sensors |
